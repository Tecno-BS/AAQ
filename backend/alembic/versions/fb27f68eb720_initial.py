...
Revision ID: fb27f68eb720
Revises: 
Create Date: 2026-02-10 11:08:09.053536
...
def upgrade() -> None:
    ...
    sa.Column('chart_insights', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
    sa.Column('key_findings', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
    sa.Column('implications', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
    ...
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('study_id', sa.UUID(), nullable=False),
    sa.Column('profile', sa.String(length=500), nullable=False),
    ...
    sa.Column('qualitative_study', sa.Text(), nullable=True),
    sa.ForeignKeyConstraint(['study_id'], ['studies.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
